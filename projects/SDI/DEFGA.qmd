...
description: "This project focuses on designing a Spatial Data Infrastructure (SDI) to integrate and visualize gender-disaggregated employment data across Austria. Utilizing open-source tools, the SDI consolidates datasets from Statistik Austria and Eurostat into a PostGIS-enabled database. It publishes OGC-compliant web services via GeoServer and ArcGIS Server, and presents an interactive dashboard developed with R Shiny. The platform enables spatial analysis of employment trends, highlighting regional and temporal disparities, and supports informed policy-making."
categories: [SDI]
---
