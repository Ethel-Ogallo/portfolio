...
#draft: true
description: "This project involved designing and implementing a spatial database backend for a WebGIS application supporting a city festival. Utilizing PostGIS, the database efficiently managed geospatial data such as booth locations, event zones, and facilities. It facilitated dynamic, location-based queries for users and organizers, enhancing real-time decision-making. The design emphasized data normalization, spatial indexing, and seamless integration with QGIS for data visualization."
