...
format:
  html:
    ...
    css: DE_styles.css 
draft: false
description: "This project highlights the use of cloud-based platforms for big data analytics in Earth Observation. It discusses three studies: temporal forest change detection in GEE, soil moisture monitoring using EO Browser, and seasonal water mapping with Sen2Cube. Collectively, these projects show how scalable cloud tools can process vast datasets, generate environmental insights, and support sustainable resource management."
